...
__all__ = ["load_dior_instances", "register_dior"]
...
def load_dior_instances(dirname: str, split: str, class_names: Union[List[str], Tuple[str, ...]]):
    """
...
def register_dior(name, dirname, split):
    # if "voc_coco" in name:
    #     class_names = VOC_COCO_CLASS_NAMES
    # else:
    #     class_names = tuple(VOC_CLASS_NAMES)
    class_names = DOTA_CLASS_NAMES
    DatasetCatalog.register(name, lambda: load_dior_instances(dirname, split, class_names))
